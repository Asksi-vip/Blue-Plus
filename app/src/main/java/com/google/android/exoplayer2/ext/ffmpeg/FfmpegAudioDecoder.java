...
/* package */ final class FfmpegAudioDecoder
  ...
  protected SimpleDecoderOutputBuffer createOutputBuffer() {
    return new SimpleDecoderOutputBuffer(
        new com.google.android.exoplayer2.decoder.DecoderOutputBuffer.Owner<SimpleDecoderOutputBuffer>() {
          @Override
          public void releaseOutputBuffer(SimpleDecoderOutputBuffer outputBuffer) {
